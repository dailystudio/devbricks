...
public abstract class AbsAsyncAdapterViewLayout<Item, ItemSet, ItemHolder extends RecyclerView.ViewHolder>
    ...
    public AbsAsyncAdapterViewLayout(Context context) {
        this(context, null);
    }

    public AbsAsyncAdapterViewLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AbsAsyncAdapterViewLayout(Context context, AttributeSet attrs, int defStyle) {
