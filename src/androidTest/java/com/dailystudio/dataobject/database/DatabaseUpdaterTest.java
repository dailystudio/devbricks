...
public class DatabaseUpdaterTest extends ActivityTestCase {
	...
	public void testDoUpdate() {
		...
		connectivity = new DatabaseConnectivity(
				mTargetContext, AUTHORITY, DynamicColumnsObject.class, DatabaseObject.VERSION_START);
		...
		connectivity = new DatabaseConnectivity(
				mTargetContext, AUTHORITY, DynamicColumnsObject.class, DatabaseObject.VERSION_START + 1);
		...
		connectivity = new DatabaseConnectivity(
				mTargetContext, AUTHORITY, DynamicColumnsObject.class);
